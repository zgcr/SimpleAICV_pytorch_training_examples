...
def parse_args():
    ...
    parser.add_argument(
        ...
        type=str,
        default=
        '/root/code/SimpleAICV_pytorch_training_examples/gradio_demo/test_face_parsing_images/CelebAMask-HQ_10008.jpg',
        help='input image path')
    parser.add_argument(
        '--output-image-path',
        type=str,
        default=
        '/root/code/SimpleAICV_pytorch_training_examples/inference_demo/inference_face_parsing_result.jpg',
