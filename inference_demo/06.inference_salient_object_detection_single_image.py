...
def parse_args():
    ...
    parser.add_argument(
        ...
        type=str,
        default=
        '/root/code/SimpleAICV_pytorch_training_examples/gradio_demo/test_salient_object_detection_images/HRSOD_11866374765_54b2ff86de_o.jpg',
        help='input image path')
    parser.add_argument(
        '--output-image-path',
        type=str,
        default=
        '/root/code/SimpleAICV_pytorch_training_examples/inference_demo/inference_salient_object_detection_result.jpg',
