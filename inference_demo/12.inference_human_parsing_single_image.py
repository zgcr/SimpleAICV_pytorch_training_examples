...
def parse_args():
    ...
    parser.add_argument(
        ...
        type=str,
        default=
        '/root/code/SimpleAICV_pytorch_training_examples/gradio_demo/test_human_parsing_images/LIP_100034_483681.jpg',
        help='input image path')
    parser.add_argument(
        '--output-image-path',
        type=str,
        default=
        '/root/code/SimpleAICV_pytorch_training_examples/inference_demo/inference_human_parsing_result.jpg',
