...
def parse_args():
    ...
    parser.add_argument(
        ...
        type=str,
        default=
        '/root/code/SimpleAICV_pytorch_training_examples/gradio_demo/test_ocr_text_detection_images/ICDAR2019ReCTS_text_detection_train_ReCTS_000049.jpg',
        help='input image path')
    parser.add_argument(
        '--output-image-path',
        type=str,
        default=
        '/root/code/SimpleAICV_pytorch_training_examples/inference_demo/inference_ocr_text_detect_result.jpg',
