...
class config:
    ...
    trained_model_path = '/root/code/SimpleAICV-ImageNet-CIFAR-COCO-VOC-training/distillation_training/imagenet/resnet_34_dkd_18/checkpoints/student-epoch100-acc72.164.pth'
