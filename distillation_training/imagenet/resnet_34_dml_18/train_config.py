...
class config:
    ...
    teacher_pretrained_model_path = '/root/code/SimpleAICV-ImageNet-CIFAR-COCO-VOC-training/pretrained_models/classification_training/resnet/resnet34-acc73.752.pth'
