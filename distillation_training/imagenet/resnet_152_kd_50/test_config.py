...
class config:
    ...
    trained_model_path = '/root/code/SimpleAICV-ImageNet-CIFAR-COCO-VOC-training/distillation_training/imagenet/resnet_152_kd_50/checkpoints/student-epoch100-acc76.536.pth'
