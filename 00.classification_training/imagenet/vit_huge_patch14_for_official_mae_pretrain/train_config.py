...
class config:
    ...
    trained_model_path = '/root/code/SimpleAICV_pytorch_training_examples/pretrained_models/vit_convert_from_official_mae_pretrain/mae_pretrain_vit_huge_pytorch_official_weight_convert.pth'
