...
class config:
    ...
    trained_model_path = '/root/autodl-tmp/pretrained_models/vit_mae_pretrain_convert_from_pytorch_official_weights/mae_pretrain_vit_huge_pytorch_official_weight_convert.pth'
