...
class config:
    ...
    trained_model_path = '/root/autodl-tmp/pretrained_models/convformer_convert_from_pytorch_official_weights/convformer_s18_384_in21ft1k_pytorch_official_weight_convert.pth'
