...
class config:
    ...
    # trained_model_path = '/root/autodl-tmp/pretrained_models/resnet_convert_from_pytorch_official_weights/resnet152-394f9c45-acc1-78.312_pytorch_official_weight_convert.pth'
