...
class config:
    ...
    trained_model_path = '/root/code/SimpleAICV_pytorch_training_examples/pretrained_models/convformer_convert_from_official_weights/convformer_m36_384_in21ft1k_pytorch_official_weight_convert.pth'
