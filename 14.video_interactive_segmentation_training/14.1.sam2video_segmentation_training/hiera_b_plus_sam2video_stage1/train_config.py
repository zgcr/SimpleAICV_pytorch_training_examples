...
from SimpleAICV.video_interactive_segmentation.losses import SAM2Loss
from SimpleAICV.video_interactive_segmentation.datasets.sam2_image_segmentation_dataset import SAM2ImageSegmentationDataset
from SimpleAICV.video_interactive_segmentation.common import Sam2Resize, Sam2RandomHorizontalFlip, Sam2RandomMosaicAug, Sam2RandomRsverseFrameOrder, Sam2Normalize, SAM2BatchCollater, load_state_dict
...
class config:
    ...
    trained_model_path = '/root/autodl-tmp/pretrained_models/sam2.1_convert_from_pytorch_official_weights/sam2.1_hiera_base_plus_convert_from_pytorch_official_weight.pth'
    load_state_dict(trained_model_path, model)

    train_criterion = SAM2Loss(alpha=0.25,
                               gamma=2,
    ...
    train_dataset = SAM2ImageSegmentationDataset(
    ...
    train_collater = SAM2BatchCollater(resize=input_image_size)
