...
class config:
    ...
    trained_model_path = '/root/autodl-tmp/pretrained_models/sam2_segmentation_train_on_video_interactive_segmentation_dataset/hiera_b_plus_sam2video_stage2_epoch_40.pth'
    ...
    train_dataset = SAM2VideoSegmentationDataset(
        ...
        per_video_choose_frame_nums=16,
