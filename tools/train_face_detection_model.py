...
from tools.face_detection_scripts import train_face_detection, validate_face_detection_for_all_dataset
...
def parse_args():
    parser = argparse.ArgumentParser(
        description='PyTorch Face Detection Training')
    parser.add_argument(
        '--work-dir',
        type=str,
...
def main():
    ...
    val_criterion = config.val_criterion.cuda()
    ...
    for epoch in range(start_epoch, config.epochs + 1):
        ...
        train_loss = train_face_detection(train_loader, model, train_criterion,
