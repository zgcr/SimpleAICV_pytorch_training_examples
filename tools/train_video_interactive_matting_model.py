...
from tools.video_interactive_matting_scripts import train_sam2_matting
...
def parse_args():
    parser = argparse.ArgumentParser(
        description='PyTorch Video Interactive Matting Training')
    parser.add_argument(
        '--work-dir',
        type=str,
...
def main():
    ...
    for epoch in range(start_epoch, config.epochs + 1):
        ...
        train_loss = train_sam2_matting(train_loader, model, train_criterion,
