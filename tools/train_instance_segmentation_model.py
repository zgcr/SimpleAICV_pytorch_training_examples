...
from tools.scripts import train_instance_segmentation, test_instance_segmentation
...
def parse_args():
    parser = argparse.ArgumentParser(
        description='PyTorch Instance Segmentation Training')
    parser.add_argument(
        '--work-dir',
        type=str,
...
def main():
    ...
    for epoch in range(start_epoch, config.epochs + 1):
        ...
        train_loss = train_instance_segmentation(train_loader, model,
        ...
        if epoch == config.epochs:
            result_dict = test_instance_segmentation(test_loader, model,
                                                     test_criterion, decoder,
                                                     config)
