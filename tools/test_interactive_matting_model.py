...
from tools.interactive_matting_scripts import validate_matting_for_all_dataset
from tools.utils import get_logger, set_seed


def parse_args():
    parser = argparse.ArgumentParser(
        description='PyTorch Interactive Matting Testing')
...
def main():
    ...
    result_dict = validate_matting_for_all_dataset(test_loader_list, model,
                                                   config)
