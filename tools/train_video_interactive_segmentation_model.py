...
from tools.video_interactive_segmentation_scripts import train_sam2_segmentation
...
def parse_args():
    parser = argparse.ArgumentParser(
        description='PyTorch Video Interactive Segmentation Training')
    parser.add_argument(
        '--work-dir',
        type=str,
...
def main():
    ...
    for epoch in range(start_epoch, config.epochs + 1):
        ...
        train_loss = train_sam2_segmentation(train_loader, model,
