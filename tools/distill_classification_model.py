...
from tools.scripts import train_distill_classification, validate_distill_classification
...
def main():
    ...
    for epoch in range(start_epoch, config.epochs + 1):
        ...
        tea_acc1, tea_acc5, tea_test_loss, stu_acc1, stu_acc5, stu_test_loss = validate_distill_classification(
            val_loader, model, test_criterion, config)
