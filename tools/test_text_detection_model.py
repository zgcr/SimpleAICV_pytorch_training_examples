...
from tools.text_scripts import test_text_detection_for_all_dataset
from tools.utils import get_logger, set_seed, compute_macs_and_params


def parse_args():
    parser = argparse.ArgumentParser(
        description='PyTorch Text Detection Testing')
...
def main():
    ...
    result_dict = test_text_detection_for_all_dataset(val_loader_list, model,
