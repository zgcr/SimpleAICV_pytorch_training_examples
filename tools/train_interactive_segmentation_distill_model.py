...
from tools.interactive_segmentation_scripts import train_distill_sam_model
...
def parse_args():
    parser = argparse.ArgumentParser(
        description='PyTorch Interactive Segmentation Distill Model Training')
    parser.add_argument(
        '--work-dir',
        type=str,
...
def main():
    ...
    for epoch in range(start_epoch, config.epochs + 1):
        ...
        train_loss = train_distill_sam_model(train_loader, model,
