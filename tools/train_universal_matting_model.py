...
from tools.universal_matting_scripts import train_universal_matting
...
def parse_args():
    parser = argparse.ArgumentParser(
        description='PyTorch Universal Matting Training')
    parser.add_argument(
        '--work-dir',
        type=str,
...
def main():
    ...
    for epoch in range(start_epoch, config.epochs + 1):
        ...
        train_loss = train_universal_matting(train_loader, model,
