...
seed = 0
model_name = 'convformerm36_dbnet'
trained_model_path = '/root/autodl-tmp/pretrained_models/dbnet_train_on_ocr_text_detection_dataset/convformerm36_dbnet-metric91.327.pth'
