...
trained_model_path = '/root/code/SimpleAICV_pytorch_training_examples_on_ImageNet_COCO_ADE20K/pretrained_models/ocr_text_detection_trained_models/VANDBNet-metric89.877.pth'
