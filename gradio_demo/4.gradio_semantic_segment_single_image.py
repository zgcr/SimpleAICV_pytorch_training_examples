...
seed = 0
model_name = 'convformerm36_deeplabv3plus'
# ade20k class
model_num_classes = 150
classes_name = ADE20K_CLASSES
classes_color = ADK20K_CLASSES_COLOR

trained_model_path = '/root/autodl-tmp/pretrained_models/deeplabv3plus_train_on_ade20k/convformerm36_deeplabv3plus-metric47.826.pth'
