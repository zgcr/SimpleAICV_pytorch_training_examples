...
trained_model_path = '/root/code/SimpleAICV_pytorch_training_examples_on_ImageNet_COCO_ADE20K/pretrained_models/ocr_text_recognition_trained_models/VANb1CTCModel-metric98.869.pth'
resize_h = 32
str_max_length = 80
...
def preprocess_image(image, resize_h):
    ...
    padded_img = np.zeros((resize_h, resize_w + padded_w, 1), dtype=np.float32)
