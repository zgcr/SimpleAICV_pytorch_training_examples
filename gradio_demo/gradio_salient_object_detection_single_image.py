...
seed = 0
model_name = 'van_b2_pfan_segmentation'

trained_model_path = '/root/code/SimpleAICV_pytorch_training_examples_on_ImageNet_COCO_ADE20K/pretrained_models/pfan_segmentation_model_train_from_scratch_on_salient_object_detection_dataset/van_b2_pfan_segmentation_miou_average_0.8866.pth'
