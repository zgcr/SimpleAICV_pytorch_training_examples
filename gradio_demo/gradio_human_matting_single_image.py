...
seed = 0
model_name = 'van_b2_pfan_matting'

trained_model_path = '/root/code/SimpleAICV_pytorch_training_examples_on_ImageNet_COCO_ADE20K/pretrained_models/pfan_matting_model_train_from_scratch_on_human_matting_dataset/van_b2_pfan_matting-metric0.985.pth'
