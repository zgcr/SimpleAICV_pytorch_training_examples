...
| Network | input size | epochs | Mask     | mae    | psnr   | ssim   | fid    |
| ------- | ---------- | ------ | -------- | ------ | ------ | ------ | ------ |
| AOT-GAN | 512x512    | 5      | 0.01-0.1 | 0.0041 | 35.479 | 0.9772 | 0.1518 |
| AOT-GAN | 512x512    | 5      | 0.1-0.2  | 0.0114 | 29.276 | 0.9378 | 0.5504 |
| AOT-GAN | 512x512    | 5      | 0.2-0.3  | 0.0213 | 25.858 | 0.8866 | 1.4065 |
| AOT-GAN | 512x512    | 5      | 0.3-0.4  | 0.0328 | 23.470 | 0.8314 | 2.9936 |
| AOT-GAN | 512x512    | 5      | 0.4-0.5  | 0.0463 | 21.590 | 0.7711 | 5.8776 |
| AOT-GAN | 512x512    | 5      | 0.5-0.6  | 0.0720 | 19.029 | 0.6851 | 16.803 |


| Network       | input size | epochs | Mask     | mae    | psnr   | ssim   | fid    |
| ------------- | ---------- | ------ | -------- | ------ | ------ | ------ | ------ |
| AOT-GAN-light | 512x512    | 5      | 0.01-0.1 | 0.0044 | 34.932 | 0.9754 | 0.1946 |
| AOT-GAN-light | 512x512    | 5      | 0.1-0.2  | 0.0122 | 28.858 | 0.9336 | 0.7815 |
| AOT-GAN-light | 512x512    | 5      | 0.2-0.3  | 0.0225 | 25.526 | 0.8805 | 2.1669 |
| AOT-GAN-light | 512x512    | 5      | 0.3-0.4  | 0.0345 | 23.196 | 0.8238 | 4.8066 |
| AOT-GAN-light | 512x512    | 5      | 0.4-0.5  | 0.0485 | 21.362 | 0.7625 | 9.5062 |
| AOT-GAN-light | 512x512    | 5      | 0.5-0.6  | 0.0747 | 18.879 | 0.6771 | 24.950 |
...
| Network | input size | epochs | Mask     | mae    | psnr   | ssim   | fid    |
| ------- | ---------- | ------ | -------- | ------ | ------ | ------ | ------ |
| AOT-GAN | 512x512    | 1      | 0.01-0.1 | 0.0040 | 35.596 | 0.9775 | 0.1396 |
| AOT-GAN | 512x512    | 1      | 0.1-0.2  | 0.0113 | 29.338 | 0.9382 | 0.4866 |
| AOT-GAN | 512x512    | 1      | 0.2-0.3  | 0.0212 | 25.882 | 0.8868 | 1.2023 |
| AOT-GAN | 512x512    | 1      | 0.3-0.4  | 0.0327 | 23.464 | 0.8309 | 2.4987 |
| AOT-GAN | 512x512    | 1      | 0.4-0.5  | 0.0462 | 21.566 | 0.7696 | 4.9181 |
| AOT-GAN | 512x512    | 1      | 0.5-0.6  | 0.0721 | 18.974 | 0.6804 | 14.437 |


| Network       | input size | epochs | Mask     | mae    | psnr   | ssim   | fid    |
| ------------- | ---------- | ------ | -------- | ------ | ------ | ------ | ------ |
| AOT-GAN-light | 512x512    | 1      | 0.01-0.1 | 0.0042 | 35.217 | 0.9763 | 0.1695 |
| AOT-GAN-light | 512x512    | 1      | 0.1-0.2  | 0.0118 | 29.055 | 0.9356 | 0.6544 |
| AOT-GAN-light | 512x512    | 1      | 0.2-0.3  | 0.0219 | 25.659 | 0.8835 | 1.7514 |
| AOT-GAN-light | 512x512    | 1      | 0.3-0.4  | 0.0336 | 23.281 | 0.8275 | 3.8301 |
| AOT-GAN-light | 512x512    | 1      | 0.4-0.5  | 0.0474 | 21.409 | 0.7665 | 7.5940 |
| AOT-GAN-light | 512x512    | 1      | 0.5-0.6  | 0.0739 | 18.853 | 0.6803 | 20.025 |
