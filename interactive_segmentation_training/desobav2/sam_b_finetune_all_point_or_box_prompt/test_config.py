...
from simpleAICV.interactive_segmentation.datasets.desobav2dataset import DESOBAV2Dataset
...
class config:
    ...
    trained_model_path = '/root/code/SimpleAICV_pytorch_training_examples_on_ImageNet_COCO_ADE20K/interactive_segmentation_training/desobav2/sam_b_finetune_all_point_or_box_prompt/checkpoints/epoch_200.pth'
    ...
    test_dataset = DESOBAV2Dataset(desoba_v2_dataset_path,
