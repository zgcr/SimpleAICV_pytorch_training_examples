...
from simpleAICV.interactive_segmentation.datasets.salient_object_detection_dataset import SalientObjectDetectionDataset
...
class config:
    ...
    trained_model_path = '/root/code/SimpleAICV_pytorch_training_examples_on_ImageNet_COCO_ADE20K/interactive_segmentation_training/salient_object_detection/sam_b_finetune_all_point_or_box_prompt/checkpoints/epoch_500.pth'
    ...
    test_dataset = SalientObjectDetectionDataset(
