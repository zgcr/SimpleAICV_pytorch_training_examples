...
from simpleAICV.detection.models.anchor import RetinaAnchors
...
if __name__ == '__main__':
    ...
    for x, y, z in zip(cls_heads, reg_heads, batch_anchors):
        print('1111', x.shape, y.shape, z.shape)
