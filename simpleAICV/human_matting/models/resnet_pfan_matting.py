...
class ResNetPFANMatting(nn.Module):
    ...
    def __init__(self,
                 ...
                 cpfe_planes=32):
        super(ResNetPFANMatting, self).__init__()
...
def _resnet_pfan_matting(backbone_type, backbone_pretrained_path, planes,
                         **kwargs):
    model = ResNetPFANMatting(
...
def resnet18_pfan_matting(backbone_pretrained_path='', **kwargs):
    return _resnet_pfan_matting('resnet18backbone', backbone_pretrained_path,
                                [64, 128, 256, 512], **kwargs)


def resnet34_pfan_matting(backbone_pretrained_path='', **kwargs):
    return _resnet_pfan_matting('resnet34backbone', backbone_pretrained_path,
                                [64, 128, 256, 512], **kwargs)


def resnet50_pfan_matting(backbone_pretrained_path='', **kwargs):
    return _resnet_pfan_matting('resnet50backbone', backbone_pretrained_path,
