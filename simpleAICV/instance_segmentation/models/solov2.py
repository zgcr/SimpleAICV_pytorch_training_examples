    ...
    def forward(self, inputs):
        ...
        for i in range(len(self.inplanes) - 1, 0, -1):
            laterals_features[i - 1] = F.interpolate(
                ...
                mode='bilinear',
                align_corners=True) + laterals_features[i - 1]
...
def resnet18_solov2(backbone_pretrained_path='', **kwargs):
    return _solov2('resnet18backbone',
                   backbone_pretrained_path=backbone_pretrained_path,
                   **kwargs)


def resnet34_solov2(backbone_pretrained_path='', **kwargs):
    return _solov2('resnet34backbone',
                   backbone_pretrained_path=backbone_pretrained_path,
                   **kwargs)


def resnet50_solov2(backbone_pretrained_path='', **kwargs):
    return _solov2('resnet50backbone',
                   backbone_pretrained_path=backbone_pretrained_path,
                   **kwargs)


def resnet101_solov2(backbone_pretrained_path='', **kwargs):
    return _solov2('resnet101backbone',
                   backbone_pretrained_path=backbone_pretrained_path,
                   **kwargs)


def resnet152_solov2(backbone_pretrained_path='', **kwargs):
    return _solov2('resnet152backbone',
                   backbone_pretrained_path=backbone_pretrained_path,
                   **kwargs)
