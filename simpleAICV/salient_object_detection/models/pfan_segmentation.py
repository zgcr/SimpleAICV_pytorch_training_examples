...
__all__ = [
    ...
    'resnet101_pfan_segmentation',
    'resnet152_pfan_segmentation',
    'vanb0_pfan_segmentation',
    'vanb1_pfan_segmentation',
    'vanb2_pfan_segmentation',
    'vanb3_pfan_segmentation',
    'convformers18_pfan_segmentation',
    'convformers36_pfan_segmentation',
    'convformerm36_pfan_segmentation',
    'convformerb36_pfan_segmentation',
]
...
if __name__ == '__main__':
    ...
    net = resnet18_pfan_segmentation()
    ...
    net = resnet34_pfan_segmentation()
    image_h, image_w = 832, 832
    from thop import profile
    from thop import clever_format
    macs, params = profile(net,
    ...
    net = resnet101_pfan_segmentation()
    image_h, image_w = 832, 832
    from thop import profile
    from thop import clever_format
    macs, params = profile(net,
    ...
    net = resnet152_pfan_segmentation()
    image_h, image_w = 832, 832
    from thop import profile
    from thop import clever_format
    macs, params = profile(net,
    ...
    net = vanb3_pfan_segmentation(use_gradient_checkpoint=True)
    image_h, image_w = 832, 832
    outs = net(torch.autograd.Variable(torch.randn(3, 3, image_h, image_w)))
    out = net(torch.rand(1, 3, image_h, image_w))
    print('2222', out.shape, torch.max(out), torch.min(out))

    net = convformers18_pfan_segmentation()
    image_h, image_w = 832, 832
    from thop import profile
    from thop import clever_format
    macs, params = profile(net,
    ...
    net = convformers36_pfan_segmentation()
    image_h, image_w = 832, 832
    from thop import profile
    from thop import clever_format
    macs, params = profile(net,
    ...
    net = convformerm36_pfan_segmentation()
    image_h, image_w = 832, 832
    from thop import profile
    from thop import clever_format
    macs, params = profile(net,
    ...
    net = convformerb36_pfan_segmentation()
    image_h, image_w = 832, 832
    from thop import profile
    from thop import clever_format
    macs, params = profile(net,
