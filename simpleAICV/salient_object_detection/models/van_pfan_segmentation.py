...
__all__ = [
    'van_b0_pfan_segmentation',
    'van_b1_pfan_segmentation',
    'van_b2_pfan_segmentation',
]
...
def van_b0_pfan_segmentation(backbone_pretrained_path='', **kwargs):
    return _van_pfan_segmentation('van_b0', backbone_pretrained_path,
                                  [32, 64, 160, 256], **kwargs)


def van_b1_pfan_segmentation(backbone_pretrained_path='', **kwargs):
    return _van_pfan_segmentation('van_b1', backbone_pretrained_path,
                                  [64, 128, 320, 512], **kwargs)


def van_b2_pfan_segmentation(backbone_pretrained_path='', **kwargs):
    return _van_pfan_segmentation('van_b2', backbone_pretrained_path,
                                  [64, 128, 320, 512], **kwargs)
