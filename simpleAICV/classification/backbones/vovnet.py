        ...
        self.layer = nn.Sequential(
            nn.Sequential(
                ...
                nn.Conv2d(planes,
                          ...
                          groups=1,
                          bias=False))
            if has_depthwise else nn.Conv2d(inplanes,
                                            planes,
                                            kernel_size,
                                            stride=stride,
                                            padding=padding,
...
class VoVNet(nn.Module):
    def __init__(self, vovnet_type, num_classes=1000):
        ...
        vovnet_config = types_config[vovnet_type]
        self.stem_channel = vovnet_config['stem_channel']
        self.per_stage_inter_channels = vovnet_config[
            'per_stage_inter_channels']
        self.per_stage_inout_channels = vovnet_config[
            'per_stage_inout_channels']
        self.per_block_layer_nums = vovnet_config['per_block_layer_nums']
        self.per_stage_block_nums = vovnet_config['per_stage_block_nums']
        self.has_se = vovnet_config['has_se']
        self.has_depthwise = vovnet_config['has_depthwise']
...
def VoVNet19_slim_depthwise_se(pretrained=False, **kwargs):
    return _vovnet('VoVNet19_slim_depthwise_se', pretrained, **kwargs)


def VoVNet19_depthwise_se(pretrained=False, **kwargs):
    return _vovnet('VoVNet19_depthwise_se', pretrained, **kwargs)


def VoVNet19_slim_se(pretrained=False, **kwargs):
    return _vovnet('VoVNet19_slim_se', pretrained, **kwargs)


def VoVNet19_se(pretrained=False, **kwargs):
    return _vovnet('VoVNet19_se', pretrained, **kwargs)


def VoVNet39_se(pretrained=False, **kwargs):
    return _vovnet('VoVNet39_se', pretrained, **kwargs)


def VoVNet57_se(pretrained=False, **kwargs):
    return _vovnet('VoVNet57_se', pretrained, **kwargs)


def VoVNet99_se(pretrained=False, **kwargs):
    return _vovnet('VoVNet99_se', pretrained, **kwargs)


if __name__ == '__main__':
    net = VoVNet('VoVNet19_slim_depthwise_se', num_classes=1000)
