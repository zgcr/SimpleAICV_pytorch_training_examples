...
This is an unofficial implementation, not completely same as the official implementation
'''
import os
import sys
...
def round_filters(filters, super_parameters):
    width_coefficient = super_parameters.width_coefficient
    depth_divisor = super_parameters.depth_divisor
...
def round_repeats(repeats, super_parameters):
    depth_coefficient = super_parameters.depth_coefficient
...
class EfficientNet(nn.Module):
    def __init__(self,
        ...
        self.efficientnet_type = types_config[efficientnet_type]
...
def efficientnet_b0(pretrained=False, **kwargs):
    return _efficientnet('efficientnet_b0', origin_globalparams,
                         origin_blocks_args, pretrained, **kwargs)
