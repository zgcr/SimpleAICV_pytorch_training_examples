...
if __name__ == '__main__':
    ...
    saved_model_path = '/root/autodl-tmp/pretrained_models/convformer_official_model/convformer_b36_in21k.pth'
    ...
    save_pth_path = f'/root/code/SimpleAICV_pytorch_training_examples/pretrained_models/convformer_convert_from_official_weights/{save_model_name}_pytorch_official_weight_convert.pth'
