...
if __name__ == '__main__':
    ...
    saved_model_path = '/root/autodl-tmp/pretrained_models/vit_official_mae_pretrain/mae_pretrain_vit_huge.pth'
    ...
    torch.save(
        convert_dict,
        f'/root/code/SimpleAICV_pytorch_training_examples/pretrained_models/vit_convert_from_official_mae_pretrain/{save_model_name}_pytorch_official_weight_convert.pth'
    )
