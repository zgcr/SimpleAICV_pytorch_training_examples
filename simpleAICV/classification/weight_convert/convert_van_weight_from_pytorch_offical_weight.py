...
if __name__ == '__main__':
    ...
    # saved_model_path = '/root/autodl-tmp/pretrained_models/van_official_model/van_b4.pth'
    ...
    # torch.save(
    #     convert_dict,
    #     f'/root/code/SimpleAICV_pytorch_training_examples/pretrained_models/van_convert_from_official_weights/{save_model_name}_pytorch_official_weight_convert.pth'
    # )
    ...
    saved_model_path = '/root/autodl-tmp/pretrained_models/van_official_model/van_b6_22k.pth'
    saved_state_dict = torch.load(saved_model_path,
                                  map_location=torch.device('cpu'))
