...
__all__ = [
    'sapiens_0_3b_human_parsing',
    'sapiens_0_6b_human_parsing',
    'sapiens_1_0b_human_parsing',
    'sapiens_2_0b_human_parsing',
]
...
def _vit_human_parsing(backbone_type, backbone_pretrained_path, planes,
                       **kwargs):
...
def sapiens_0_3b_human_parsing(backbone_pretrained_path='', **kwargs):
    return _vit_human_parsing('sapiens_0_3b_backbone',
                              backbone_pretrained_path, 1024, **kwargs)


def sapiens_0_6b_human_parsing(backbone_pretrained_path='', **kwargs):
    return _vit_human_parsing('sapiens_0_6b_backbone',
                              backbone_pretrained_path, 1280, **kwargs)


def sapiens_1_0b_human_parsing(backbone_pretrained_path='', **kwargs):
    return _vit_human_parsing('sapiens_1_0b_backbone',
                              backbone_pretrained_path, 1536, **kwargs)


def sapiens_2_0b_human_parsing(backbone_pretrained_path='', **kwargs):
    return _vit_human_parsing('sapiens_2_0b_backbone',
                              backbone_pretrained_path, 1920, **kwargs)
...
if __name__ == '__main__':
    ...
    net = sapiens_0_3b_human_parsing(image_size=512)
    ...
    net = sapiens_0_6b_human_parsing(image_size=512)
    image_h, image_w = 512, 512
    from thop import profile
    from thop import clever_format
    macs, params = profile(net,
    ...
    net = sapiens_1_0b_human_parsing(image_size=512)
    image_h, image_w = 512, 512
    from thop import profile
    from thop import clever_format
    macs, params = profile(net,
    ...
    net = sapiens_2_0b_human_parsing(image_size=512)
    image_h, image_w = 512, 512
    from thop import profile
    from thop import clever_format
    macs, params = profile(net,
