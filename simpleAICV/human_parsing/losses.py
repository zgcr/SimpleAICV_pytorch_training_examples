...
if __name__ == '__main__':
    ...
    from simpleAICV.human_parsing.common import RandomCrop, RandomShrink, RandomRGBToGRAY, RandomHorizontalFlip, RandomVerticalFlip, YoloStyleResize, Resize, Normalize, HumanParsingCollater
    ...
    collater = HumanParsingCollater(resize=512)
    ...
    from simpleAICV.human_parsing.models.pfan_human_parsing import resnet50_pfan_human_parsing
    net = resnet50_pfan_human_parsing(num_classes=20)
