...
from simpleAICV.interactive_segmentation.models.segment_anything_matting.sam_matting1 import FUSION, MaskDecoderMatting

__all__ = [
    'vanb0_light_sam_matting1',
    'vanb1_light_sam_matting1',
    'vanb2_light_sam_matting1',
    'vanb3_light_sam_matting1',
    'convformers18_light_sam_matting1',
    'convformers36_light_sam_matting1',
    'convformerm36_light_sam_matting1',
    'convformerb36_light_sam_matting1',
]
...
class LIGHTSAMMATTING(nn.Module):
    ...
    def __init__(self,
        ...
        self.fusion_pred = FUSION(planes=matting_planes,
                                  cpfe_planes=matting_cpfe_planes,
                                  mask_out_idx_num=mask_out_idx_num)
    ...
    def forward(self, batch_images, batch_prompts, mask_out_idxs=[0, 1, 2, 3]):
        ...
        batch_masks_global_preds, batch_masks_local_preds = self.fusion_pred(
            masks, feat3, feat1)
        batch_masks_fused_preds = self.collaborative_matting(
            batch_masks_global_preds, batch_masks_local_preds)

        batch_iou_preds = torch.mean(iou_predictions, dim=1, keepdim=True)
...
def _light_sam_matting1(image_size, patch_size, backbone_type, **kwargs):
...
def vanb0_light_sam_matting1(image_size=1024, patch_size=16, **kwargs):
    return _light_sam_matting1(image_size=image_size,
                               patch_size=patch_size,
                               backbone_type='vanb0backbone',
                               **kwargs)


def vanb1_light_sam_matting1(image_size=1024, patch_size=16, **kwargs):
    return _light_sam_matting1(image_size=image_size,
                               patch_size=patch_size,
...
def vanb2_light_sam_matting1(image_size=1024, patch_size=16, **kwargs):
    return _light_sam_matting1(image_size=image_size,
                               patch_size=patch_size,
...
def vanb3_light_sam_matting1(image_size=1024, patch_size=16, **kwargs):
    return _light_sam_matting1(image_size=image_size,
                               patch_size=patch_size,
...
def convformers18_light_sam_matting1(image_size=1024, patch_size=16, **kwargs):
    return _light_sam_matting1(image_size=image_size,
                               patch_size=patch_size,
...
def convformers36_light_sam_matting1(image_size=1024, patch_size=16, **kwargs):
    return _light_sam_matting1(image_size=image_size,
                               patch_size=patch_size,
...
def convformerm36_light_sam_matting1(image_size=1024, patch_size=16, **kwargs):
    return _light_sam_matting1(image_size=image_size,
                               patch_size=patch_size,
...
def convformerb36_light_sam_matting1(image_size=1024, patch_size=16, **kwargs):
    return _light_sam_matting1(image_size=image_size,
                               patch_size=patch_size,
...
if __name__ == '__main__':
    ...
    net = convformerm36_light_sam_matting1(image_size=1024,
                                           frozen_image_encoder=False,
                                           frozen_prompt_encoder=False,
                                           frozen_mask_decoder=False,
