...
class FUSION(nn.Module):
    ...
    def __init__(self, planes=[32, 256], cpfe_planes=32, mask_out_idx_num=4):
        ...
        self.global_feat1_reduce_conv = ConvBnActBlock(planes[-2],
                                                       ...
                                                       has_bn=True,
                                                       has_act=True)
        self.global_combine_conv = ConvBnActBlock(int(2 * cpfe_planes) +
                                                  mask_out_idx_num,
                                                  cpfe_planes,
                                                  kernel_size=1,
                                                  stride=1,
        ...
        self.local_feat1_reduce_conv = ConvBnActBlock(planes[-2],
                                                      ...
                                                      has_bn=True,
                                                      has_act=True)
        self.local_combine_conv = ConvBnActBlock(int(4 * cpfe_planes) +
                                                 mask_out_idx_num,
                                                 cpfe_planes,
                                                 kernel_size=1,
                                                 stride=1,
...
def _sam_matting1(image_size, patch_size, image_encoder_embedding_planes,
...
def sam_b_matting1(image_size=1024, patch_size=16, **kwargs):
    return _sam_matting1(image_size=image_size,
                         patch_size=patch_size,
                         image_encoder_embedding_planes=768,
                         image_encoder_block_nums=12,
                         image_encoder_head_nums=12,
...
def sam_l_matting1(image_size=1024, patch_size=16, **kwargs):
    return _sam_matting1(image_size=image_size,
                         patch_size=patch_size,
...
def sam_h_matting1(image_size=1024, patch_size=16, **kwargs):
    return _sam_matting1(image_size=image_size,
                         patch_size=patch_size,
