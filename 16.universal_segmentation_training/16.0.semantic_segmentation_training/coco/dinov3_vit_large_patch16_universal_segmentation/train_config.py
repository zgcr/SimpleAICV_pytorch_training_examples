...
from SimpleAICV.universal_segmentation.datasets.cocosemanticsegmentationdataset import CocoSemanticSegmentation
from SimpleAICV.universal_segmentation.semantic_segmentation_common import YoloStyleResize, RandomHorizontalFlip, Normalize, SemanticSegmentationTrainCollater, load_state_dict
...
class config:
    ...
    train_collater = SemanticSegmentationTrainCollater(resize=input_image_size)
