...
class config:
    ...
    trained_model_path = '/root/autodl-tmp/pretrained_models/universal_segmentation_train_semantic_segmentation_on_coco/dinov3_vit_large_patch16_universal_segmentation_epoch_100.pth'
