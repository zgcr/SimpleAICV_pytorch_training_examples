...
from SimpleAICV.universal_segmentation.datasets.human_instance_matting_dataset import HumanInstanceMattingDataset
from SimpleAICV.universal_segmentation.human_instance_matting_common import RandomHorizontalFlip, Resize, Normalize, HumanInstanceMattingTrainCollater, load_state_dict
...
class config:
    ...
    train_dataset = HumanInstanceMattingDataset(
    ...
    train_collater = HumanInstanceMattingTrainCollater(
