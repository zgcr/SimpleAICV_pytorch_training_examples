...
from SimpleAICV.universal_segmentation.salient_object_detection_common import RandomHorizontalFlip, YoloStyleResize, Resize, Normalize, SalientObjectDetectionSegmentationTrainCollater, load_state_dict
...
class config:
    ...
    train_collater = SalientObjectDetectionSegmentationTrainCollater(
