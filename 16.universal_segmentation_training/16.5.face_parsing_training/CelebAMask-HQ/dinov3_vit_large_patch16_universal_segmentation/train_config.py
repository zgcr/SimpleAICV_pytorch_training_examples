...
from SimpleAICV.universal_segmentation.datasets.face_parsing_dataset import FaceParsingDataset, CelebAMask_HQ_19_CLASSES
from SimpleAICV.universal_segmentation.face_parsing_common import YoloStyleResize, RandomHorizontalFlip, Normalize, FaceParsingTrainCollater, load_state_dict
...
class config:
    ...
    train_collater = FaceParsingTrainCollater(resize=input_image_size[0])
