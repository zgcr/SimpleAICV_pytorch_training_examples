...
from SimpleAICV.universal_segmentation.datasets.human_parsing_dataset import HumanParsingDataset, CIHP_20_CLASSES
from SimpleAICV.universal_segmentation.human_parsing_common import YoloStyleResize, RandomHorizontalFlip, Normalize, HumanParsingTestCollater, load_state_dict
...
class config:
    ...
    trained_model_path = '/root/autodl-tmp/pretrained_models/universal_segmentation_train_human_parsing_on_CIHP/dinov3_vit_large_patch16_universal_segmentation_epoch_100.pth'
    ...
    val_collater = HumanParsingTestCollater(resize=input_image_size[0])
