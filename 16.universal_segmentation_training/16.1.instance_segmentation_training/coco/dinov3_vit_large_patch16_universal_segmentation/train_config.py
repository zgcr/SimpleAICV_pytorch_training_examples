...
from SimpleAICV.universal_segmentation.instance_segmentation_common import InstanceSegmentationResize, RandomHorizontalFlip, Normalize, InstanceSegmentationTrainCollater, load_state_dict
...
class config:
    ...
    train_collater = InstanceSegmentationTrainCollater(
