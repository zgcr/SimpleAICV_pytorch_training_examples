...
def main():
    ...
    with torch.no_grad():
        for idx, per_sample in tqdm(enumerate(show_dataset)):
            if idx >= config.save_num:
                break
            ...
            origin_image_name = f'image_{idx}_original.jpg'
            masked_image_name = f'image_{idx}_masked.jpg'
            reconstruciton_image_name = f'image_{idx}_reconstruciton.jpg'
            combined_image_name = f'image_{idx}_combined.jpg'
