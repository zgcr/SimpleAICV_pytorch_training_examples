...
class config:
    ...
    trained_model_path = '/root/code/SimpleAICV_pytorch_training_examples_on_ImageNet_COCO_ADE20K/pretrained_models/retinanet_finetune_on_coco_from_objects365_pretrain/resnet50_retinanet-yoloresize800-metric40.483.pth'
