...
class config:
    ...
    trained_model_path = '/root/code/SimpleAICV_pytorch_training_examples_on_ImageNet_COCO_ADE20K/pretrained_models/retinanet_train_from_scratch_on_coco/resnet50_retinanet-yoloresize800-metric36.023.pth'
