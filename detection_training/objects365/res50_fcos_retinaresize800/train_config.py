...
class config:
    ...
    trained_model_path = '/root/code/SimpleAICV_pytorch_training_examples_on_ImageNet_COCO_ADE20K/pretrained_models/fcos_train_from_scratch_on_coco/resnet50_fcos-metric39.649.pth'
