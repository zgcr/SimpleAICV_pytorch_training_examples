...
class config:
    ...
    trained_model_path = '/root/code/SimpleAICV-ImageNet-CIFAR-COCO-VOC-training/detection_training/coco/res101_fcos_retinaresize800/checkpoints/resnet101_fcos-metric39.560.pth'
