...
class config:
    ...
    trained_model_path = '/root/code/SimpleAICV-ImageNet-CIFAR-COCO-VOC-training/detection_training/coco/res50_retinanet_retinaresize400/checkpoints/resnet50_retinanet-metric31.945.pth'
