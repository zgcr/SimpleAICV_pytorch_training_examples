...
class config:
    ...
    trained_model_path = '/root/code/SimpleAICV-ImageNet-CIFAR-COCO-VOC-training/detection_training/coco/res101_retinanet_retinaresize800/checkpoints/resnet101_retinanet-metric36.413.pth'
