...
class config:
    ...
    trained_model_path = '/root/code/SimpleAICV-ImageNet-CIFAR-COCO-VOC-training/detection_training/coco/res18_ttfnet_yoloresize512_3x/checkpoints/resnet18_ttfnet-metric27.631.pth'
