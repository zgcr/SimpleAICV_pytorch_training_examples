...
class config:
    ...
    trained_model_path = '/root/code/SimpleAICV-ImageNet-CIFAR-COCO-VOC-training/detection_training/coco/res50_fcos_yoloresize640/checkpoints/resnet50_fcos-metric35.649.pth'
