...
class config:
    ...
    trained_model_path = '/root/code/SimpleAICV_pytorch_training_examples_on_ImageNet_COCO_ADE20K/pretrained_models/retinanet_train_on_objects365_2020/resnet50_retinanet-yoloresize800-metric16.360.pth'
