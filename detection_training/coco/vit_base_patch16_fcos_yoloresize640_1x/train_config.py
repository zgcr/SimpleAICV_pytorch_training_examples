...
from simpleAICV.detection.common import RetinaStyleResize, YoloStyleResize, RandomHorizontalFlip, RandomCrop, RandomTranslate, Normalize, AlignResizeDetectionCollater, load_state_dict
...
class config:
    network = 'vit_base_backbone_patch16_fcos'
    num_classes = 80
    ...
    train_collater = AlignResizeDetectionCollater(resize=input_image_size[0])
    test_collater = AlignResizeDetectionCollater(resize=input_image_size[0])
