...
class config:
    ...
    trained_model_path = '/root/code/SimpleAICV_pytorch_training_examples_on_ImageNet_COCO_ADE20K/pretrained_models/fcos_train_on_objects365_2020/resnet50_fcos-retinaresize800-metric17.068.pth'
