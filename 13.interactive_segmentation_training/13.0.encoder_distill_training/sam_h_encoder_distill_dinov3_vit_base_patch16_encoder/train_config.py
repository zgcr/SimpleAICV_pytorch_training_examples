...
class config:
    ...
    freeze_teacher = True
    teacher_encoder_trained_model_path = '/root/autodl-tmp/pretrained_models/sam_encoder_weights_convert_from_pytorch_official_weights/sam_vit_h_4b8939_encoder_convert_from_pytorch_official_weight.pth'
