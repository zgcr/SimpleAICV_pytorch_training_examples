...
class config:
    ...
    trained_model_path = '/root/autodl-tmp/pretrained_models/light_sam_matting_train_on_salient_object_detection/convformerm36_light_sam_matting1-loss0.124.pth'
