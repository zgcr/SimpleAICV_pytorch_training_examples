...
class config:
    ...
    trained_model_path = '/root/autodl-tmp/pretrained_models/sam_segmentation_train_on_interactive_segmentation_dataset/sam_b_epoch_2.pth'
    ...
    train_criterion = losses_matting.__dict__['SAMMattingLoss'](
        **{
