...
class config:
    network = 'resnet50_pfan_face_parsing'
    # 包含背景类
    num_classes = 19
    ...
    trained_model_path = '/root/autodl-tmp/pretrained_models/face_parsing_train_on_FaceSynthetics/resnet50_pfan_face_parsing_epoch_100.pth'
