...
class config:
    ...
    backbone_pretrained_path = '/root/autodl-tmp/pretrained_models/dinov3_pytorch_official_weights/DINOv3_ViT_LVD-1689M/dinov3_vitb16_pretrain_lvd1689m-73cec8be.pth'
    ...
    trained_model_path = '/root/autodl-tmp/pretrained_models/face_parsing_train_on_FaceSynthetics/dinov3_vit_base_patch16_pfan_face_parsing_epoch_100.pth'
