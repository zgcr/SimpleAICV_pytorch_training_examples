...
from simpleAICV.semantic_segmentation.common import Resize, RandomCrop, RandomHorizontalFlip, PhotoMetricDistortion, Normalize, AlignResizeSemanticSegmentationCollater, load_state_dict
...
class config:
    network = 'segmenter_vit_base_patch16_mask'
    ...
    backbone_pretrained_path = '/root/code/SimpleAICV-ImageNet-CIFAR-COCO-VOC-training/pretrained_models/masked_image_modeling_training/vit/mae-vit-base-patch16-224-epoch400-pretrain-model-loss0.388_encoder.pth'
    ...
    train_collater = AlignResizeSemanticSegmentationCollater(
        resize=input_image_size, divisor=32, ignore_index=ignore_index)
    test_collater = AlignResizeSemanticSegmentationCollater(
        resize=input_image_size, divisor=32, ignore_index=ignore_index)
