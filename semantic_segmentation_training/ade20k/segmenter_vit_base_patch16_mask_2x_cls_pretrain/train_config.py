...
class config:
    ...
    backbone_pretrained_path = '/root/code/SimpleAICV-ImageNet-CIFAR-COCO-VOC-training/pretrained_models/classification_training/vit/finetune-vit-base-patch16-224-epoch100-for-mae-epoch400-acc83.130.pth'
