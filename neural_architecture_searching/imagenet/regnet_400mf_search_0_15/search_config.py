...
from regnet import RegNet, get_regnet_config
    ...
    while net_num_idx < sample_candidate_net_num:
        ...
        for param_name, param_range in base_net_param_range_config.items():
            ...
            if not param_sample_type:
                ...
                if param_name in ['w_0', 'group_width']:
        ...
        w_0, group_width = new_net_config['w_0'], new_net_config['group_width']
        if group_width > w_0:
            new_net_config['group_width'] = w_0
...
class config:
    ...
    sample_net_config = {
        'base_net_param_range_config': {
            ...
            'w_a': ([24, 128], 'log'),
            'w_m': ([2.0, 3.2], 'float'),
            'group_width': ([8, 240], 'int'),
            'bottleneck_ratio': (1.0, None),
        },
        'target_glops': 0.4,
