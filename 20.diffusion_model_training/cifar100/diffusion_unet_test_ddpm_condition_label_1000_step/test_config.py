...
from simpleAICV.diffusion_model.common import Opencv2PIL, TorchMeanStdNormalize, DiffusionWithLabelCollater
...
class config:
    ...
    trained_model_path = '/root/autodl-tmp/pretrained_models/diffusion_unet_train_on_cifar100/diffusion_unet_train_ddpm_condition_label_loss0.026.pth'
    ...
    test_collater = DiffusionWithLabelCollater()
