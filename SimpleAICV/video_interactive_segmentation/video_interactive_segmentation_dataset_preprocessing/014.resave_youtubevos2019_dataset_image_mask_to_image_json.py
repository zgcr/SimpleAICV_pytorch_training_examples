...
def process_videos(root_path, save_path, set_type):
    ...
    if set_type == 'valid':
        ...
        save_set_type = set_type

    save_path = os.path.join(save_path, save_set_type)
    if not os.path.exists(save_path):
        os.makedirs(save_path)

    root_dataset_path = os.path.join(root_path, set_type, 'JPEGImages')
    ...
    for per_video_name in sorted(os.listdir(root_dataset_path)):
        ...
        mask_dataset_path = os.path.join(root_path, set_type, 'Annotations')
...
if __name__ == "__main__":
    root_path = r'/root/autodl-tmp/YouTubeVOS2019'
    save_path = r'/root/autodl-tmp/video_interactive_segmentation_dataset/YouTubeVOS2019'
    set_type = 'valid'
