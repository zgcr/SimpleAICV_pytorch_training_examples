...
def process_videos(root_path, save_path):
    root_name_prefix1 = root_path.split('/')[-2]
    root_name_prefix2 = root_path.split('/')[-1]
    root_name = f'{root_name_prefix1}_{root_name_prefix2}'
...
if __name__ == "__main__":
    root_path = r'/root/autodl-tmp/MaGGIe-HIM/V-HIM60/comp_easy'
    save_path = r'/root/autodl-tmp/video_interactive_segmentation_dataset/V-HIM60_comp_easy'
    process_videos(root_path=root_path, save_path=save_path)

    root_path = r'/root/autodl-tmp/MaGGIe-HIM/V-HIM60/comp_medium'
    save_path = r'/root/autodl-tmp/video_interactive_segmentation_dataset/V-HIM60_comp_medium'
    process_videos(root_path=root_path, save_path=save_path)

    root_path = r'/root/autodl-tmp/MaGGIe-HIM/V-HIM60/comp_hard'
    save_path = r'/root/autodl-tmp/video_interactive_segmentation_dataset/V-HIM60_comp_hard'
    process_videos(root_path=root_path, save_path=save_path)