...
class SAM2VideoSegmentationDataset(Dataset):
    ...
    def __getitem__(self, idx):
        ...
        if video_type == 'sam2':
            ...
            #     frames_masks.append(per_frame_mask)
            # frames_masks = np.stack(frames_masks, axis=0).astype(np.float32)
            # frames_masks = (frames_masks > 0.5).astype(np.float32)
...
if __name__ == '__main__':
    ...
    from SimpleAICV.video_interactive_segmentation.common import Sam2Resize, Sam2RandomHorizontalFlip, Sam2RandomMosaicAug, Sam2RandomRsverseFrameOrder, Sam2Normalize, SAM2VideoBatchCollater
    ...
    sam2_video_dataset = SAM2VideoSegmentationDataset(
        ...
        transform=transforms.Compose([
            ...
            Sam2RandomHorizontalFlip(prob=1.0),
            Sam2RandomMosaicAug(prob=0.1),
            Sam2RandomRsverseFrameOrder(prob=1.0),
    ...
    collater = SAM2VideoBatchCollater(resize=1024, use_image_prob=0.1)
