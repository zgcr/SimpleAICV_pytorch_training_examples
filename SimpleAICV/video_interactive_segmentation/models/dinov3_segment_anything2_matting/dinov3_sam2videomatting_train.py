...
__all__ = [
    'dinov3_vit_small_patch16_sam2video_matting',
    'dinov3_vit_small_plus_patch16_sam2video_matting',
    'dinov3_vit_base_patch16_sam2video_matting',
    'dinov3_vit_large_patch16_sam2video_matting',
    'dinov3_vit_large_plus_patch16_sam2video_matting',
    'dinov3_vit_huge_plus_patch16_sam2video_matting',
]
...
class DINOV3SAM2VideoMatting(nn.Module):
    ...
    def __init__(self,
        ...
        super(DINOV3SAM2VideoMatting, self).__init__()
...
def _dinov3_sam2videomatting(backbone_type, backbone_pretrained_path,
                             image_size, patch_size,
                             prompt_encoder_embedding_planes, **kwargs):
    model = DINOV3SAM2VideoMatting(
        backbone_type=backbone_type,
        backbone_pretrained_path=backbone_pretrained_path,
        image_size=image_size,
        patch_size=patch_size,
...
def dinov3_vit_small_patch16_sam2video_matting(backbone_pretrained_path='',
                                               image_size=1024,
                                               patch_size=16,
                                               **kwargs):
    return _dinov3_sam2videomatting(
...
def dinov3_vit_small_plus_patch16_sam2video_matting(backbone_pretrained_path='',
                                                    image_size=1024,
                                                    patch_size=16,
                                                    **kwargs):
    return _dinov3_sam2videomatting(
...
def dinov3_vit_base_patch16_sam2video_matting(backbone_pretrained_path='',
                                              image_size=1024,
                                              patch_size=16,
                                              **kwargs):
    return _dinov3_sam2videomatting(
...
def dinov3_vit_large_patch16_sam2video_matting(backbone_pretrained_path='',
                                               image_size=1024,
                                               patch_size=16,
                                               **kwargs):
    return _dinov3_sam2videomatting(
...
def dinov3_vit_large_plus_patch16_sam2video_matting(backbone_pretrained_path='',
                                                    image_size=1024,
                                                    patch_size=16,
                                                    **kwargs):
    return _dinov3_sam2videomatting(
...
def dinov3_vit_huge_plus_patch16_sam2video_matting(backbone_pretrained_path='',
                                                   image_size=1024,
                                                   patch_size=16,
                                                   **kwargs):
    return _dinov3_sam2videomatting(
