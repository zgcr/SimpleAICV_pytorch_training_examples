...
__all__ = [
    'hiera_t_sam2video_matting_test',
    'hiera_s_sam2video_matting_test',
    'hiera_b_plus_sam2video_matting_test',
    'hiera_l_sam2video_matting_test',
]


class SAM2VideoMattingTest(nn.Module):
    ...
    def __init__(
        ...
        super(SAM2VideoMattingTest, self).__init__()
...
def _sam2videomattingtest(
        image_size, patch_size, image_encoder_embedding_planes,
        image_encoder_head_nums, image_encoder_block_nums,
        image_encoder_window_position_embedding_bkg_spatial_size,
        image_encoder_window_specification,
        image_encoder_global_attention_blocks, prompt_encoder_embedding_planes,
        **kwargs):
    model = SAM2VideoMattingTest(
        image_size=image_size,
        patch_size=patch_size,
...
def hiera_t_sam2video_matting_test(image_size=1024, patch_size=16, **kwargs):
    return _sam2videomattingtest(
        image_size=image_size,
        patch_size=patch_size,
...
def hiera_s_sam2video_matting_test(image_size=1024, patch_size=16, **kwargs):
    return _sam2videomattingtest(
        image_size=image_size,
        patch_size=patch_size,
        image_encoder_embedding_planes=96,
...
def hiera_b_plus_sam2video_matting_test(image_size=1024,
                                        patch_size=16,
                                        **kwargs):
    return _sam2videomattingtest(
        image_size=image_size,
...
def hiera_l_sam2video_matting_test(image_size=1024, patch_size=16, **kwargs):
    return _sam2videomattingtest(
        image_size=image_size,
        patch_size=patch_size,
