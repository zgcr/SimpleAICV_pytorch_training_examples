...
__all__ = [
    'hiera_t_sam2image_matting',
    'hiera_s_sam2image_matting',
    'hiera_b_plus_sam2image_matting',
    'hiera_l_sam2image_matting',
]


class SAM2ImageMatting(nn.Module):
    ...
    def __init__(
        ...
        super(SAM2ImageMatting, self).__init__()
...
def _sam2imagematting(image_size, patch_size, image_encoder_embedding_planes,
...
def hiera_t_sam2image_matting(image_size=1024, patch_size=16, **kwargs):
    return _sam2imagematting(
        image_size=image_size,
        patch_size=patch_size,
...
def hiera_s_sam2image_matting(image_size=1024, patch_size=16, **kwargs):
    return _sam2imagematting(
        image_size=image_size,
        patch_size=patch_size,
        image_encoder_embedding_planes=96,
...
def hiera_b_plus_sam2image_matting(image_size=1024, patch_size=16, **kwargs):
    return _sam2imagematting(
        image_size=image_size,
        patch_size=patch_size,
        image_encoder_embedding_planes=112,
...
def hiera_l_sam2image_matting(image_size=1024, patch_size=16, **kwargs):
    return _sam2imagematting(
        image_size=image_size,
        patch_size=patch_size,
...
if __name__ == '__main__':
    ...
    net = hiera_b_plus_sam2image_matting(use_gradient_checkpoint=True)
    load_state_dict('', net)
