...
def hiera_t_sam2image(image_size=1024, patch_size=16, **kwargs):
    return _sam2image(
        image_size=image_size,
        patch_size=patch_size,
...
def hiera_s_sam2image(image_size=1024, patch_size=16, **kwargs):
    return _sam2image(
        image_size=image_size,
        patch_size=patch_size,
        image_encoder_embedding_planes=96,
...
def hiera_b_plus_sam2image(image_size=1024, patch_size=16, **kwargs):
    return _sam2image(
        image_size=image_size,
        patch_size=patch_size,
        image_encoder_embedding_planes=112,
...
def hiera_l_sam2image(image_size=1024, patch_size=16, **kwargs):
    return _sam2image(
        image_size=image_size,
        patch_size=patch_size,
...
if __name__ == '__main__':
    ...
    net = hiera_b_plus_sam2image(use_gradient_checkpoint=True)
    load_state_dict('', net)
