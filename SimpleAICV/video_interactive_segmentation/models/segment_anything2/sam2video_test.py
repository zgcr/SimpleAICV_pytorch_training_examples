...
__all__ = [
    'hiera_t_sam2video_test',
    'hiera_s_sam2video_test',
    'hiera_b_plus_sam2video_test',
    'hiera_l_sam2video_test',
]
...
class SAM2VideoTest(nn.Module):
    ...
    def __init__(
        ...
        super(SAM2VideoTest, self).__init__()
...
def _sam2videotest(image_size, patch_size, image_encoder_embedding_planes,
...
def hiera_t_sam2video_test(image_size=1024, patch_size=16, **kwargs):
    return _sam2videotest(
        image_size=image_size,
        patch_size=patch_size,
...
def hiera_s_sam2video_test(image_size=1024, patch_size=16, **kwargs):
    return _sam2videotest(
        image_size=image_size,
        patch_size=patch_size,
        image_encoder_embedding_planes=96,
...
def hiera_b_plus_sam2video_test(image_size=1024, patch_size=16, **kwargs):
    return _sam2videotest(
        image_size=image_size,
        patch_size=patch_size,
        image_encoder_embedding_planes=112,
...
def hiera_l_sam2video_test(image_size=1024, patch_size=16, **kwargs):
    return _sam2videotest(
        image_size=image_size,
        patch_size=patch_size,
