...
from SimpleAICV.video_interactive_segmentation.models.segment_anything2.transformer import TwoWayTransformer
...
class MaskDecoder(nn.Module):
    ...
    def forward(self,
        ...
        return mask_preds, iou_preds, mask_tokens_out, object_score_logits
...
if __name__ == '__main__':
    ...
    for data in tqdm(train_loader):
        ...
        batch_image_embeddings, _ = image_encoder_net(input_images)

        print('2222', batch_image_embeddings[0].shape,
        ...
        mask_preds, iou_preds, mask_tokens_out, object_score_logits = mask_decoder_net(
        ...
        print('4444', mask_preds.shape, iou_preds.shape, mask_tokens_out.shape,
