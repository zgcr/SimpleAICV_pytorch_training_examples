...
__all__ = [
    'dinov3_vit_small_patch16_fcos',
    'dinov3_vit_small_plus_patch16_fcos',
    'dinov3_vit_base_patch16_fcos',
    'dinov3_vit_large_patch16_fcos',
    'dinov3_vit_large_plus_patch16_fcos',
    'dinov3_vit_huge_plus_patch16_fcos',
]
...
def dinov3_vit_small_patch16_fcos(backbone_pretrained_path='', **kwargs):
    return _fcos('dinov3_vit_small_patch16_backbone',
                 backbone_pretrained_path=backbone_pretrained_path,
                 **kwargs)


def dinov3_vit_small_plus_patch16_fcos(backbone_pretrained_path='', **kwargs):
    return _fcos('dinov3_vit_small_plus_patch16_backbone',
                 backbone_pretrained_path=backbone_pretrained_path,
                 **kwargs)


def dinov3_vit_base_patch16_fcos(backbone_pretrained_path='', **kwargs):
    return _fcos('dinov3_vit_base_patch16_backbone',
                 backbone_pretrained_path=backbone_pretrained_path,
                 **kwargs)


def dinov3_vit_large_patch16_fcos(backbone_pretrained_path='', **kwargs):
    return _fcos('dinov3_vit_large_patch16_backbone',
                 backbone_pretrained_path=backbone_pretrained_path,
                 **kwargs)


def dinov3_vit_large_plus_patch16_fcos(backbone_pretrained_path='', **kwargs):
    return _fcos('dinov3_vit_large_plus_patch16_backbone',
                 backbone_pretrained_path=backbone_pretrained_path,
                 **kwargs)


def dinov3_vit_huge_plus_patch16_fcos(backbone_pretrained_path='', **kwargs):
    return _fcos('dinov3_vit_huge_plus_patch16_backbone',
                 backbone_pretrained_path=backbone_pretrained_path,
                 **kwargs)
...
if __name__ == '__main__':
    ...
    net = dinov3_vit_small_patch16_fcos()
    ...
    net = dinov3_vit_small_plus_patch16_fcos()
    image_h, image_w = 1024, 1024
    from calflops import calculate_flops
    flops, macs, params = calculate_flops(model=net,
                                          kwargs={
    ...
    net = dinov3_vit_base_patch16_fcos()
    image_h, image_w = 1024, 1024
    from calflops import calculate_flops
    flops, macs, params = calculate_flops(model=net,
                                          kwargs={
    ...
    net = dinov3_vit_large_patch16_fcos()
    image_h, image_w = 1024, 1024
    from calflops import calculate_flops
    flops, macs, params = calculate_flops(model=net,
                                          kwargs={
    ...
    net = dinov3_vit_large_plus_patch16_fcos()
    image_h, image_w = 1024, 1024
    from calflops import calculate_flops
    flops, macs, params = calculate_flops(model=net,
                                          kwargs={
    ...
    net = dinov3_vit_large_plus_patch16_fcos(use_gradient_checkpoint=True)
    image_h, image_w = 1024, 1024
    outs = net(torch.autograd.Variable(torch.randn(3, 3, image_h, image_w)))
    for out in outs:
        for per_level_out in out:
    ...
    net = dinov3_vit_huge_plus_patch16_fcos()
    image_h, image_w = 1024, 1024
    from calflops import calculate_flops
    flops, macs, params = calculate_flops(model=net,
                                          kwargs={
