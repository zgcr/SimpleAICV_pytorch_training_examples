...
__all__ = [
    'dinov3_vit_small_patch16_pfan_semantic_segmentation',
    'dinov3_vit_small_plus_patch16_pfan_semantic_segmentation',
    'dinov3_vit_base_patch16_pfan_semantic_segmentation',
    'dinov3_vit_large_patch16_pfan_semantic_segmentation',
    'dinov3_vit_large_plus_patch16_pfan_semantic_segmentation',
    'dinov3_vit_huge_plus_patch16_pfan_semantic_segmentation',
]
...
class PFANSemanticSegmentation(nn.Module):
    ...
    def forward(self, x):
        ...
        x = self.backbone(x)
        # torch.Size([1, 256, 128, 128]) torch.Size([1, 256, 64, 64]) torch.Size([1, 256, 32, 32]) torch.Size([1, 256, 16, 16])
...
def dinov3_vit_small_patch16_pfan_semantic_segmentation(
        backbone_pretrained_path='', **kwargs):
    return _pfan_semantic_segmentation('dinov3_vit_small_patch16_backbone',
                                       backbone_pretrained_path, 256, **kwargs)


def dinov3_vit_small_plus_patch16_pfan_semantic_segmentation(
        backbone_pretrained_path='', **kwargs):
    return _pfan_semantic_segmentation(
        'dinov3_vit_small_plus_patch16_backbone', backbone_pretrained_path,
        256, **kwargs)


def dinov3_vit_base_patch16_pfan_semantic_segmentation(
        backbone_pretrained_path='', **kwargs):
    return _pfan_semantic_segmentation('dinov3_vit_base_patch16_backbone',
                                       backbone_pretrained_path, 256, **kwargs)


def dinov3_vit_large_patch16_pfan_semantic_segmentation(
        backbone_pretrained_path='', **kwargs):
    return _pfan_semantic_segmentation('dinov3_vit_large_patch16_backbone',
                                       backbone_pretrained_path, 256, **kwargs)


def dinov3_vit_large_plus_patch16_pfan_semantic_segmentation(
        backbone_pretrained_path='', **kwargs):
    return _pfan_semantic_segmentation(
        'dinov3_vit_large_plus_patch16_backbone', backbone_pretrained_path,
        256, **kwargs)


def dinov3_vit_huge_plus_patch16_pfan_semantic_segmentation(
        backbone_pretrained_path='', **kwargs):
    return _pfan_semantic_segmentation('dinov3_vit_huge_plus_patch16_backbone',
                                       backbone_pretrained_path, 256, **kwargs)
...
if __name__ == '__main__':
    ...
    net = dinov3_vit_small_patch16_pfan_semantic_segmentation()
    ...
    net = dinov3_vit_small_plus_patch16_pfan_semantic_segmentation()
    image_h, image_w = 512, 512
    from calflops import calculate_flops
    flops, macs, params = calculate_flops(model=net,
                                          kwargs={
    ...
    net = dinov3_vit_base_patch16_pfan_semantic_segmentation()
    image_h, image_w = 512, 512
    from calflops import calculate_flops
    flops, macs, params = calculate_flops(model=net,
                                          kwargs={
    ...
    net = dinov3_vit_large_patch16_pfan_semantic_segmentation()
    image_h, image_w = 512, 512
    from calflops import calculate_flops
    flops, macs, params = calculate_flops(model=net,
                                          kwargs={
    ...
    net = dinov3_vit_large_plus_patch16_pfan_semantic_segmentation()
    image_h, image_w = 512, 512
    from calflops import calculate_flops
    flops, macs, params = calculate_flops(model=net,
                                          kwargs={
    ...
    net = dinov3_vit_huge_plus_patch16_pfan_semantic_segmentation()
    image_h, image_w = 512, 512
    from calflops import calculate_flops
    flops, macs, params = calculate_flops(model=net,
                                          kwargs={
