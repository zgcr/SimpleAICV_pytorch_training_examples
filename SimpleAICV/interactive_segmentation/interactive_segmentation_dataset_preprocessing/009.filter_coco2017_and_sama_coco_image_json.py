...
if __name__ == '__main__':
    root_dataset_path = f'/root/autodl-tmp/interactive_segmentation_dataset/COCO2017'
    save_dataset_path = f'/root/autodl-tmp/interactive_segmentation_dataset_new2/COCO2017'
    preprocess_image(root_dataset_path, save_dataset_path)

    root_dataset_path = f'/root/autodl-tmp/interactive_segmentation_dataset/SAMA-COCO'
    save_dataset_path = f'/root/autodl-tmp/interactive_segmentation_dataset_new2/SAMA-COCO'
    preprocess_image(root_dataset_path, save_dataset_path)
