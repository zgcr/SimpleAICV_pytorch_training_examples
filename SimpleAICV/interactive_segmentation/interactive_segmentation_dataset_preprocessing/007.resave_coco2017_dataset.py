...
def preprocess_image(root_dataset_path,
    ...
    for per_image_id in tqdm(ids):
        ...
        new_file_name = 'coco_2017_' + file_name
        new_json_name = 'coco_2017_' + file_name.split('.jpg')[0] + '.json'
...
if __name__ == '__main__':
    root_dataset_path = r'/root/autodl-tmp/COCO2017'
    save_dataset_path = r'/root/autodl-tmp/interactive_segmentation_dataset/COCO2017'
    set_name = 'train2017'
