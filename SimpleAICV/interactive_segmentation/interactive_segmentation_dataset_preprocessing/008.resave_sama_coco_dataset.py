...
def preprocess_image(root_dataset_path, save_dataset_path, set_name='train'):
    os.makedirs(save_dataset_path, exist_ok=True)

    image_dir = os.path.join(root_dataset_path, 'images', set_name)
    ...
    for per_image_id in tqdm(ids):
        ...
        file_name = coco.loadImgs(per_image_id)[0]['file_name']

        new_file_name = 'sama_coco_' + file_name
        new_json_name = 'sama_coco_' + file_name.split('.jpg')[0] + '.json'
...
if __name__ == '__main__':
    root_dataset_path = r'/root/autodl-tmp/SAMA-COCO'
    save_dataset_path = r'/root/autodl-tmp/interactive_segmentation_dataset/SAMA-COCO'
    set_name = 'train'
