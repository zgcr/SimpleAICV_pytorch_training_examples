...
def preprocess_image(root_dataset_path, save_dataset_path):
    save_dataset_path = os.path.join(save_dataset_path, 'test')
    os.makedirs(save_dataset_path, exist_ok=True)

    root_image_path = os.path.join(root_dataset_path, 'img')
    root_mask_path = os.path.join(root_dataset_path, 'mask')
...
if __name__ == '__main__':
    root_dataset_path = r'/root/autodl-tmp/refmatte/RefMatte_RW_100'
    save_dataset_path = r'/root/autodl-tmp/interactive_segmentation_dataset/RefMatte_RW_100'
