...
__all__ = [
    'dinov3_vit_small_patch16_sam',
    'dinov3_vit_small_plus_patch16_sam',
    'dinov3_vit_base_patch16_sam',
    'dinov3_vit_large_patch16_sam',
    'dinov3_vit_large_plus_patch16_sam',
    'dinov3_vit_huge_plus_patch16_sam',
]


class DINOV3SAM(nn.Module):
...
def _dinov3_sam(backbone_type, backbone_pretrained_path,
...
def dinov3_vit_small_patch16_sam(backbone_pretrained_path='', **kwargs):
    return _dinov3_sam('dinov3_vit_small_patch16_backbone',
                       backbone_pretrained_path, 256, **kwargs)


def dinov3_vit_small_plus_patch16_sam(backbone_pretrained_path='', **kwargs):
    return _dinov3_sam('dinov3_vit_small_plus_patch16_backbone',
                       backbone_pretrained_path, 256, **kwargs)


def dinov3_vit_base_patch16_sam(backbone_pretrained_path='', **kwargs):
    return _dinov3_sam('dinov3_vit_base_patch16_backbone',
                       backbone_pretrained_path, 256, **kwargs)


def dinov3_vit_large_patch16_sam(backbone_pretrained_path='', **kwargs):
    return _dinov3_sam('dinov3_vit_large_patch16_backbone',
                       backbone_pretrained_path, 256, **kwargs)


def dinov3_vit_large_plus_patch16_sam(backbone_pretrained_path='', **kwargs):
    return _dinov3_sam('dinov3_vit_large_plus_patch16_backbone',
                       backbone_pretrained_path, 256, **kwargs)


def dinov3_vit_huge_plus_patch16_sam(backbone_pretrained_path='', **kwargs):
    return _dinov3_sam('dinov3_vit_huge_plus_patch16_backbone',
                       backbone_pretrained_path, 256, **kwargs)
...
if __name__ == '__main__':
    ...
    net = dinov3_vit_base_patch16_sam(use_gradient_checkpoint=True)
    load_state_dict(
