...
def _sam_matting(image_size, patch_size, image_encoder_embedding_planes,
...
def sam_b_matting(image_size=1024, patch_size=16, **kwargs):
    return _sam_matting(image_size=image_size,
                        patch_size=patch_size,
                        image_encoder_embedding_planes=768,
                        image_encoder_block_nums=12,
                        image_encoder_head_nums=12,
...
def sam_l_matting(image_size=1024, patch_size=16, **kwargs):
    return _sam_matting(image_size=image_size,
                        patch_size=patch_size,
...
def sam_h_matting(image_size=1024, patch_size=16, **kwargs):
    return _sam_matting(image_size=image_size,
                        patch_size=patch_size,
