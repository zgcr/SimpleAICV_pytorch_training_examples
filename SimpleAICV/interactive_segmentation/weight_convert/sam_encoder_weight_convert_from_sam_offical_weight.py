...
if __name__ == '__main__':
    ...
    saved_model_path = '/root/autodl-tmp/pretrained_models/sam_pytorch_official_weights/sam_vit_h_4b8939.pth'
    ...
    torch.save(
        convert_dict,
        f'/root/autodl-tmp/pretrained_models/sam_encoder_weights_convert_from_pytorch_official_weights/{save_model_name}_encoder_convert_from_pytorch_official_weight.pth'
    )
