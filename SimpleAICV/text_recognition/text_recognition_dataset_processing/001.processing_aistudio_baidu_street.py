...
def generate_standard_format_txt_for_each_image(root_dataset_path,
    ...
    root_dataset_label_path = os.path.join(root_dataset_path, 'train.txt')
...
if __name__ == '__main__':
    root_dataset_path = r'D:\BaiduNetdiskDownload\text_dataset\aistudio_baidu_street'
    save_dataset_path = r'D:\BaiduNetdiskDownload\text_recognition_dataset\aistudio_baidu_street'
    train_ratio = 0.8
