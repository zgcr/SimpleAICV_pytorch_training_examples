...
def generate_standard_format_txt_for_each_image(root_dataset_path,
    ...
    for per_image_origin_label in root_dataset_train_origin_labels:
    ...
    root_dataset_image_path = os.path.join(root_dataset_path, 'train_imgs')

    for per_image_name in tqdm(os.listdir(root_dataset_image_path)):
        modified_image_name = 'train_' + per_image_name
        per_image_path = os.path.join(root_dataset_image_path, per_image_name)
        if not os.path.exists(per_image_path):
            continue

        per_image_label = root_dataset_label_dict[modified_image_name]

        all_image_label_name_path_list.append([
            per_image_name, modified_image_name, per_image_path,
            per_image_label
        ])

    print('3333', len(all_image_label_name_path_list),
          all_image_label_name_path_list[0])

    root_dataset_image_path = os.path.join(root_dataset_path, 'test_imgs')

    for per_image_name in tqdm(os.listdir(root_dataset_image_path)):
        modified_image_name = 'test_' + per_image_name
        per_image_path = os.path.join(root_dataset_image_path, per_image_name)
        if not os.path.exists(per_image_path):
            continue
    ...
    print('4444', len(all_image_label_name_path_list),
          all_image_label_name_path_list[0])

    dataset_image_name_list = set()
    dataset_image_path_dict = collections.OrderedDict()
    dataset_label_dict = collections.OrderedDict()
    for per_image_name, modified_image_name, per_image_path, per_image_label in tqdm(
            all_image_label_name_path_list):
        if not os.path.exists(per_image_path):
            continue
        ...
        keep_image_name = f'{save_dataset_name}_{modified_image_name.split(".")[0]}.jpg'
    ...
    print("5555", len(dataset_image_name_list), len(dataset_image_path_dict),
    ...
    for per_image_name in tqdm(dataset_image_name_list):
        per_image_path = dataset_image_path_dict[per_image_name]
        if 'train_' in per_image_name:
...
if __name__ == '__main__':
    # root_dataset_path = r'D:\BaiduNetdiskDownload\text_dataset\meta_self_learning\car'
    # save_dataset_path = r'D:\BaiduNetdiskDownload\text_recognition_dataset\meta_self_learning_car'
    # generate_standard_format_txt_for_each_image(root_dataset_path,
    #                                             save_dataset_path)

    # root_dataset_path = r'D:\BaiduNetdiskDownload\text_dataset\meta_self_learning\hand'
    # save_dataset_path = r'D:\BaiduNetdiskDownload\text_recognition_dataset\meta_self_learning_hand'
    # generate_standard_format_txt_for_each_image(root_dataset_path,
    #                                             save_dataset_path)

    # root_dataset_path = r'D:\BaiduNetdiskDownload\text_dataset\meta_self_learning\street'
    # save_dataset_path = r'D:\BaiduNetdiskDownload\text_recognition_dataset\meta_self_learning_street'
    # generate_standard_format_txt_for_each_image(root_dataset_path,
    #                                             save_dataset_path)

    root_dataset_path = r'D:\BaiduNetdiskDownload\text_dataset\meta_self_learning\syn'
    save_dataset_path = r'D:\BaiduNetdiskDownload\text_recognition_dataset\meta_self_learning_syn'
    generate_standard_format_txt_for_each_image(root_dataset_path,
                                                save_dataset_path)
