...
__all__ = [
    'dinov3_vit_small_patch16_pfan_human_parsing',
    'dinov3_vit_small_plus_patch16_pfan_human_parsing',
    'dinov3_vit_base_patch16_pfan_human_parsing',
    'dinov3_vit_large_patch16_pfan_human_parsing',
    'dinov3_vit_large_plus_patch16_pfan_human_parsing',
    'dinov3_vit_huge_plus_patch16_pfan_human_parsing',
]
...
def dinov3_vit_small_patch16_pfan_human_parsing(backbone_pretrained_path='',
                                                **kwargs):
    return _pfan_human_parsing('dinov3_vit_small_patch16_backbone',
                               backbone_pretrained_path, 256, **kwargs)


def dinov3_vit_small_plus_patch16_pfan_human_parsing(
        backbone_pretrained_path='', **kwargs):
    return _pfan_human_parsing('dinov3_vit_small_plus_patch16_backbone',
                               backbone_pretrained_path, 256, **kwargs)


def dinov3_vit_base_patch16_pfan_human_parsing(backbone_pretrained_path='',
                                               **kwargs):
    return _pfan_human_parsing('dinov3_vit_base_patch16_backbone',
                               backbone_pretrained_path, 256, **kwargs)


def dinov3_vit_large_patch16_pfan_human_parsing(backbone_pretrained_path='',
                                                **kwargs):
    return _pfan_human_parsing('dinov3_vit_large_patch16_backbone',
                               backbone_pretrained_path, 256, **kwargs)


def dinov3_vit_large_plus_patch16_pfan_human_parsing(
        backbone_pretrained_path='', **kwargs):
    return _pfan_human_parsing('dinov3_vit_large_plus_patch16_backbone',
                               backbone_pretrained_path, 256, **kwargs)


def dinov3_vit_huge_plus_patch16_pfan_human_parsing(
        backbone_pretrained_path='', **kwargs):
    return _pfan_human_parsing('dinov3_vit_huge_plus_patch16_backbone',
                               backbone_pretrained_path, 256, **kwargs)
...
if __name__ == '__main__':
    ...
    net = dinov3_vit_small_patch16_pfan_human_parsing()
    ...
    net = dinov3_vit_small_plus_patch16_pfan_human_parsing()
    image_h, image_w = 512, 512
    from calflops import calculate_flops
    flops, macs, params = calculate_flops(model=net,
                                          kwargs={
    ...
    net = dinov3_vit_base_patch16_pfan_human_parsing()
    image_h, image_w = 512, 512
    from calflops import calculate_flops
    flops, macs, params = calculate_flops(model=net,
                                          kwargs={
    ...
    net = dinov3_vit_large_patch16_pfan_human_parsing()
    image_h, image_w = 512, 512
    from calflops import calculate_flops
    flops, macs, params = calculate_flops(model=net,
                                          kwargs={
    ...
    net = dinov3_vit_large_plus_patch16_pfan_human_parsing()
    image_h, image_w = 512, 512
    from calflops import calculate_flops
    flops, macs, params = calculate_flops(model=net,
                                          kwargs={
    ...
    net = dinov3_vit_huge_plus_patch16_pfan_human_parsing()
    image_h, image_w = 512, 512
    from calflops import calculate_flops
    flops, macs, params = calculate_flops(model=net,
                                          kwargs={
