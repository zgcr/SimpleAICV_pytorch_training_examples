...
def process_data(root_dataset_path, save_dataset_path, dataset_name):
    root_dataset_train_image_path = os.path.join(root_dataset_path,
                                                 'TrainVal_images',
                                                 'train_images')
    root_dataset_train_mask_path = os.path.join(
        root_dataset_path, 'TrainVal_parsing_annotations',
        'train_segmentations')
    ...
    root_dataset_val_image_path = os.path.join(root_dataset_path,
                                               'TrainVal_images', 'val_images')
    root_dataset_val_mask_path = os.path.join(root_dataset_path,
...
if __name__ == '__main__':
    root_dataset_path = r'/root/autodl-tmp/human_parsing_dataset_origin/LIP/'
