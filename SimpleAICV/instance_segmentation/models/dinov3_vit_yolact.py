...
__all__ = [
    'dinov3_vit_small_patch16_yolact',
    'dinov3_vit_small_plus_patch16_yolact',
    'dinov3_vit_base_patch16_yolact',
    'dinov3_vit_large_patch16_yolact',
    'dinov3_vit_large_plus_patch16_yolact',
    'dinov3_vit_huge_plus_patch16_yolact',
]
...
def dinov3_vit_small_patch16_yolact(backbone_pretrained_path='', **kwargs):
    return _yolact('dinov3_vit_small_patch16_backbone',
                   backbone_pretrained_path=backbone_pretrained_path,
                   **kwargs)


def dinov3_vit_small_plus_patch16_yolact(backbone_pretrained_path='',
                                         **kwargs):
    return _yolact('dinov3_vit_small_plus_patch16_backbone',
                   backbone_pretrained_path=backbone_pretrained_path,
                   **kwargs)


def dinov3_vit_base_patch16_yolact(backbone_pretrained_path='', **kwargs):
    return _yolact('dinov3_vit_base_patch16_backbone',
                   backbone_pretrained_path=backbone_pretrained_path,
                   **kwargs)


def dinov3_vit_large_patch16_yolact(backbone_pretrained_path='', **kwargs):
    return _yolact('dinov3_vit_large_patch16_backbone',
                   backbone_pretrained_path=backbone_pretrained_path,
                   **kwargs)


def dinov3_vit_large_plus_patch16_yolact(backbone_pretrained_path='',
                                         **kwargs):
    return _yolact('dinov3_vit_large_plus_patch16_backbone',
                   backbone_pretrained_path=backbone_pretrained_path,
                   **kwargs)


def dinov3_vit_huge_plus_patch16_yolact(backbone_pretrained_path='', **kwargs):
    return _yolact('dinov3_vit_huge_plus_patch16_backbone',
                   backbone_pretrained_path=backbone_pretrained_path,
                   **kwargs)
...
if __name__ == '__main__':
    ...
    net = dinov3_vit_small_patch16_yolact()
    ...
    net = dinov3_vit_small_patch16_yolact(use_gradient_checkpoint=True)
    image_h, image_w = 1024, 1024
    preds = net(torch.autograd.Variable(torch.randn(4, 3, image_h, image_w)))
    for per_out in preds[0]:
        print('3333', per_out.shape)
    ...
    net = dinov3_vit_small_plus_patch16_yolact()
    image_h, image_w = 1024, 1024
    from calflops import calculate_flops
    flops, macs, params = calculate_flops(model=net,
                                          kwargs={
    ...
    net = dinov3_vit_base_patch16_yolact()
    image_h, image_w = 1024, 1024
    from calflops import calculate_flops
    flops, macs, params = calculate_flops(model=net,
                                          kwargs={
    ...
    net = dinov3_vit_large_patch16_yolact()
    image_h, image_w = 1024, 1024
    from calflops import calculate_flops
    flops, macs, params = calculate_flops(model=net,
                                          kwargs={
    ...
    net = dinov3_vit_large_plus_patch16_yolact()
    image_h, image_w = 1024, 1024
    from calflops import calculate_flops
    flops, macs, params = calculate_flops(model=net,
                                          kwargs={
    ...
    net = dinov3_vit_huge_plus_patch16_yolact()
    image_h, image_w = 1024, 1024
    from calflops import calculate_flops
    flops, macs, params = calculate_flops(model=net,
                                          kwargs={
