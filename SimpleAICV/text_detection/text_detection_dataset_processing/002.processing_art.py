...
def generate_standard_format_txt_for_each_image(root_dataset_path,
    ...
    for per_image_name_prefix, per_image_name, per_image_path in tqdm(
        ...
        for per_label_line in per_image_origin_labels:
            ...
            per_label_language = per_label_line['language']
...
if __name__ == '__main__':
    root_dataset_path = r'D:\BaiduNetdiskDownload\text_dataset\ICDAR2019ART'
    save_dataset_path = r'D:\BaiduNetdiskDownload\text_dataset_处理后\ICDAR2019ART_text_detection'
    train_ratio = 0.8
