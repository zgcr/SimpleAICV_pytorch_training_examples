...
if __name__ == '__main__':
    root_dataset_path = r'D:\BaiduNetdiskDownload\text_dataset\ICDAR2017RCTW'
    save_dataset_path = r'D:\BaiduNetdiskDownload\text_dataset_处理后\ICDAR2017RCTW_text_detection'
    train_ratio = 0.8
