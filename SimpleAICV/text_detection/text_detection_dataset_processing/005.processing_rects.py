...
def generate_standard_format_txt_for_each_image(root_dataset_path,
    ...
    root_dataset_image_path = os.path.join(root_dataset_path, 'img')
    root_dataset_label_path = os.path.join(root_dataset_path, 'gt')
    ...
    for per_image_name in os.listdir(root_dataset_image_path):
        ...
        per_label_name = per_image_name_prefix + '.json'
    ...
    for per_image_name, per_label_name, per_image_path, per_label_path in tqdm(
        ...
        per_image_origin_labels = json.load(
            open(per_label_path, 'r', encoding='UTF-8'))
        per_image_origin_labels = per_image_origin_labels['chars']

        per_image_labels = []
        for per_label_line in per_image_origin_labels:
            per_label_coords = per_label_line['points']
...
if __name__ == '__main__':
    root_dataset_path = r'D:\BaiduNetdiskDownload\text_dataset\ICDAR2019ReCTS'
    save_dataset_path = r'D:\BaiduNetdiskDownload\text_dataset_处理后\ICDAR2019ReCTS_text_detection'
    train_ratio = 0.8
