...
if __name__ == '__main__':
    ...
    from SimpleAICV.universal_segmentation.face_parsing_common import RandomCrop, RandomShrink, RandomRGBToGRAY, RandomHorizontalFlip, RandomVerticalFlip, YoloStyleResize, Resize, Normalize, FaceParsingTrainCollater
    ...
    collater = FaceParsingTrainCollater(resize=512)
