...
if __name__ == '__main__':
    ...
    from SimpleAICV.universal_segmentation.human_matting_common import RandomHorizontalFlip, YoloStyleResize, Resize, Normalize, HumanMattingTrainCollater
    ...
    collater = HumanMattingTrainCollater(resize=1024)
