...
class config:
    ...
    trained_model_path = '/root/code/SimpleAICV_pytorch_training_examples_on_ImageNet_COCO_ADE20K/diffusion_model_training/ffhq/diffusion_unet_train_ddpm/checkpoints/loss0.016.pth'
    load_state_dict(trained_model_path, model)

    mean = [0.0, 0.0, 0.0]
    std = [1.0, 1.0, 1.0]
    test_dataset = FFHQDataset(root_dir=FFHQ_path,
                               set_name='training',
