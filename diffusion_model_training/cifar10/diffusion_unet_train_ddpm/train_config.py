...
from simpleAICV.diffusion_model.common import Opencv2PIL, TorchRandomHorizontalFlip, TorchMeanStdNormalize, ClassificationCollater
...
class config:
    ...
    train_dataset = CIFAR10Dataset(root_dir=CIFAR10_path,
                                   set_name='train',
