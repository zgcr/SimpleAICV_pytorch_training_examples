...
class config:
    ...
    trained_model_path = '/root/code/SimpleAICV_pytorch_training_examples_on_ImageNet_COCO_ADE20K/diffusion_model_training/cifar10/diffusion_unet_train_ddpm/checkpoints/loss0.027.pth'
