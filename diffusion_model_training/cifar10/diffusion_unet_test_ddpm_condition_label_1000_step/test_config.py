...
from simpleAICV.diffusion_model.datasets.cifar10dataset import CIFAR10Dataset
...
class config:
    ...
    trained_model_path = '/root/code/SimpleAICV_pytorch_training_examples_on_ImageNet_COCO_ADE20K/diffusion_model_training/cifar10/diffusion_unet_train_ddpm_condition_label/checkpoints/loss0.026.pth'
