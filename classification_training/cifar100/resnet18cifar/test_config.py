...
class config:
    ...
    trained_model_path = '/root/code/SimpleAICV-ImageNet-CIFAR-COCO-VOC-training/classification_training/cifar100/resnet18cifar/checkpoints/resnet18cifar-acc76.750.pth'
