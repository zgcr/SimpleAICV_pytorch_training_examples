...
class config:
    ...
    trained_model_path = '/root/code/SimpleAICV-ImageNet-CIFAR-COCO-VOC-training/classification_training/cifar100/resnet34halfcifar/checkpoints/resnet34halfcifar-acc75.720.pth'
