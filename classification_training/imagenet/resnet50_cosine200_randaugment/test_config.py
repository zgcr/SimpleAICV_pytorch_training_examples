...
class config:
    ...
    trained_model_path = '/root/code/SimpleAICV-ImageNet-CIFAR-COCO-VOC-training/classification_training/imagenet/resnet50_cosine200_randaugment/checkpoints/resnet50-acc77.846.pth'
