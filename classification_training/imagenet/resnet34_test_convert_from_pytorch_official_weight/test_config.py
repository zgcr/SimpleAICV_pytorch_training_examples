...
class config:
    ...
    trained_model_path = '/root/code/SimpleAICV_pytorch_training_examples_on_ImageNet_COCO_ADE20K/pretrained_models/resnet_convert_from_pytorch_official_weights/resnet34-b627a593-acc1-73.314_pytorch_official_weight_convert.pth'
