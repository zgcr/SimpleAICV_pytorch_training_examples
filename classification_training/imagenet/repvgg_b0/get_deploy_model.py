...
if __name__ == '__main__':
    ...
    trained_model_path = '/root/code/SimpleAICV-ImageNet-CIFAR-COCO-VOC-training/classification_training/imagenet/repvgg_b0/checkpoints/RepVGG_B0-acc74.766.pth'
