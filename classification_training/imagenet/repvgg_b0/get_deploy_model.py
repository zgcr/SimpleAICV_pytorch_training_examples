...
if __name__ == '__main__':
    ...
    trained_model_path = '/root/code/SimpleAICV_pytorch_training_examples_on_ImageNet_COCO_ADE20K/classification_training/imagenet/repvgg_b0/checkpoints/RepVGG_B0-acc74.880.pth'
