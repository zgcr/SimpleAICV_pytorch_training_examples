...
if __name__ == '__main__':
    ...
    trained_model_path = '/root/code/SimpleAICV_pytorch_training_examples_on_ImageNet_COCO_ADE20K/classification_training/imagenet/repvgg_b1/checkpoints/RepVGG_B1-acc77.790.pth'
