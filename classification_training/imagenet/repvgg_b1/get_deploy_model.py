...
if __name__ == '__main__':
    ...
    trained_model_path = '/root/code/SimpleAICV-ImageNet-CIFAR-COCO-VOC-training/classification_training/imagenet/repvgg_b1/checkpoints/RepVGG_B1-acc77.804.pth'
