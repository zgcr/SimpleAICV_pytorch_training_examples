...
class config:
    ...
    trained_model_path = '/root/code/SimpleAICV_pytorch_training_examples_on_ImageNet_COCO_ADE20K/pretrained_models/vit_mae_pretrain_on_imagenet1k/vit_small_patch16_224_mae_pretrain_model-loss0.414_encoder.pth'
