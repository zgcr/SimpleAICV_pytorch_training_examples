...
class config:
    ...
    trained_model_path = '/root/code/SimpleAICV-ImageNet-CIFAR-COCO-VOC-training/pretrained_models/masked_image_modeling_training/vit/mae-vit-base-patch16-224-epoch400-pretrain-model-loss0.388_encoder.pth'
