...
class config:
    ...
    trained_model_path = '/root/code/SimpleAICV_pytorch_training_examples_on_ImageNet_COCO_ADE20K/pretrained_models/van_weight_convert_from_official_weights/van_b3_pytorch_official_weight_convert.pth'
