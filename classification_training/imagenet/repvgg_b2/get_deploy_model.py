...
if __name__ == '__main__':
    ...
    trained_model_path = '/root/code/SimpleAICV-ImageNet-CIFAR-COCO-VOC-training/classification_training/imagenet/repvgg_b2/checkpoints/RepVGG_B2-acc78.214.pth'
