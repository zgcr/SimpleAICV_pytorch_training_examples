...
if __name__ == '__main__':
    ...
    trained_model_path = '/root/code/SimpleAICV_pytorch_training_examples_on_ImageNet_COCO_ADE20K/classification_training/imagenet/repvgg_b2/checkpoints/RepVGG_B2-acc78.120.pth'
