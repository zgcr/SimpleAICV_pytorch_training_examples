...
class config:
    ...
    trained_model_path = '/root/code/SimpleAICV-ImageNet-CIFAR-COCO-VOC-training/classification_training/imagenet/resnet34half/checkpoints/resnet34half-acc67.752.pth'
