...
class config:
    ...
    trained_model_path = '/root/code/SimpleAICV_pytorch_training_examples_on_ImageNet_COCO_ADE20K/pretrained_models/vit_convert_from_official_mae_pretrain/vit_base_patch16_official_mae_pretrain_convert.pth'
