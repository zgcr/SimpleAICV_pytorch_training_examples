...
class config:
    ...
    trained_model_path = '/root/code/SimpleAICV-ImageNet-CIFAR-COCO-VOC-training/classification_training/imagenet/resnet50_cosine200_autoaugment/checkpoints/resnet50-acc77.736.pth'
