...
class config:
    ...
    trained_model_path = '/root/code/SimpleAICV-ImageNet-CIFAR-COCO-VOC-training/classification_training/imagenet/repvgg_a0/checkpoints/RepVGG_A0-acc72.176_deployed.pth'
