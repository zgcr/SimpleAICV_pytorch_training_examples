...
if __name__ == '__main__':
    ...
    trained_model_path = '/root/code/SimpleAICV_pytorch_training_examples_on_ImageNet_COCO_ADE20K/classification_training/imagenet/repvgg_a0/checkpoints/RepVGG_A0-acc72.010.pth'
