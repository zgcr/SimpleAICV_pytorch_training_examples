...
class config:
    ...
    trained_model_path = '/root/code/SimpleAICV-ImageNet-CIFAR-COCO-VOC-training/classification_training/imagenet/regnetx_600mf/checkpoints/RegNetX_600MF-acc73.564.pth'
