...
class config:
    ...
    trained_model_path = '/root/code/SimpleAICV_pytorch_training_examples/pretrained_models/van_convert_from_official_weights/van_b3_pytorch_official_weight_convert.pth'
