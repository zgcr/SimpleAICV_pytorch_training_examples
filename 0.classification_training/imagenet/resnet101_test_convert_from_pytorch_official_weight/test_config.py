...
class config:
    ...
    # trained_model_path = '/root/code/SimpleAICV_pytorch_training_examples/pretrained_models/resnet_convert_from_pytorch_official_weights/resnet101-63fe2227-acc1-77.374_pytorch_official_weight_convert.pth'
    trained_model_path = '/root/code/SimpleAICV_pytorch_training_examples/pretrained_models/resnet_convert_from_pytorch_official_weights/resnet101-cd907fc2-acc1-81.886_pytorch_official_weight_convert.pth'
