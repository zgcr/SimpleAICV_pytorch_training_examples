...
class config:
    ...
    trained_model_path = '/root/code/SimpleAICV_pytorch_training_examples_on_ImageNet_COCO_ADE20K/ocr_text_recognition_training/repvgg_ctc_model/checkpoints/epoch_50_deployed.pth'
