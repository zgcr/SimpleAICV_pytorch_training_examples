...
class config:
    ...
    trained_generator_model_path = '/root/code/SimpleAICV_pytorch_training_examples_on_ImageNet_COCO_ADE20K/image_inpainting_training/places365_challenge/aot_gan_train/checkpoints/total_loss0.308_generator_model.pth'
    ...
    save_image_dir = '/root/autodl-tmp/places365_challenge_test_results_2'
