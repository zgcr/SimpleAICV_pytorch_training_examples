...
class config:
    ...
    trained_generator_model_path = '/root/code/SimpleAICV_pytorch_training_examples_on_ImageNet_COCO_ADE20K/pretrained_models/aot_gan_train_on_places365_challenge/aot_gan_total_loss0.322_generator_model.pth'
