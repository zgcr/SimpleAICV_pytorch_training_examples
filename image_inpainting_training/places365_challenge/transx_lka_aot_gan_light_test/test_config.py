...
class config:
    ...
    trained_generator_model_path = '/root/code/SimpleAICV_pytorch_training_examples_on_ImageNet_COCO_ADE20K/image_inpainting_training/places365_challenge/transx_lka_aot_gan_light_train/checkpoints/total_loss0.301_generator_model.pth'
    ...
    save_image_dir = '/root/autodl-tmp/places365_challenge_test_results_light/'
