...
class config:
    ...
    trained_generator_model_path = '/root/code/SimpleAICV_pytorch_training_examples_on_ImageNet_COCO_ADE20K/image_inpainting_training/places365_challenge/aot_gan_light_train/checkpoints/total_loss0.323_generator_model.pth'
