...
from tools.path import Places365_Standard_High_resolution_images_path, NVIDIA_Irregular_Mask_Dataset_test_mask_path
...
from simpleAICV.image_inpainting.models import transx_lka_aot_gan
...
class config:
    ...
    generator_model = transx_lka_aot_gan.__dict__[
        'TRANSXLKAAOTGANGeneratorModel'](**{
            'planes': [64, 96, 128, 256],
            'block_num': 8,
            'head_num': 4,
        })
    # load total pretrained model or not
    trained_generator_model_path = '/root/code/SimpleAICV_pytorch_training_examples_on_ImageNet_COCO_ADE20K/image_inpainting_training/places365_standard/transx_lka_aot_gan_light_train/checkpoints/total_loss0.309_generator_model.pth'
    ...
    for per_sub_test_dataset_name in test_dataset_name_list:
        per_sub_test_dataset = ImageInpaintingDataset(
            image_root_dir=Places365_Standard_High_resolution_images_path,
