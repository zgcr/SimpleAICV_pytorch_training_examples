...
class config:
    ...
    trained_model_path = '/root/code/SimpleAICV_pytorch_training_examples_on_ImageNet_COCO_ADE20K/ocr_text_detection_training/vanb1_dbnet/checkpoints/epoch_100.pth'
